...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String TRIALY_APP_KEY = "KJ4HE3LGZ8ODC0CVJ6S"; //TODO: Replace with your app key, which can be found on your Trialy developer dashboard
